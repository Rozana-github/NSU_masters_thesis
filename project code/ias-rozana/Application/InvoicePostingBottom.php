...
<html>
      ...
      <body class='body_e'>
            <form name='MyForm' method='POST' action='InvoicePostingBottomSave.php'>
            <?PHP
                  ...
                  if($RowCount>0)
                  {
                        ...
                        echo "<table width='90%' id='table1' cellspacing='0' cellpadding='0' align='center'>
                                    ...
                                    <tr>
                                          ...
                                          <td class='td_e'>
                                                <input type='text' class='input_e' size='50' name='Remarks' value='Beign the goods sold to ".$Company_Name."'>
