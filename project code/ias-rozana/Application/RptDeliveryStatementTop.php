...
function doPrint()
                  {
                        window.parent.RptDeliveryStatementBottom.focus();
                        window.parent.RptDeliveryStatementBottom.print();
                  }
...
<form name='frmEmployeeEntry' method='post' action='RptDeliveryStatementBottom.php' target='RptDeliveryStatementBottom'>
