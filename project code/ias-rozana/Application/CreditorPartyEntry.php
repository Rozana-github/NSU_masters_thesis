...
<body class='body_e'>
<form name='Form1' method='post'  action='AddToCreditorPartyEntry.php'>

<?PHP

$CustomerId="select
                   ifnull(lpad(max(cast(supplier_id as unsigned))+1,4,0),0) as CustomerID
             from
                   mas_supplier
            ";
...
<table border='0' width='100%'  cellspacing='0' cellpadding='3'>
        <tr>
                ...
                <td colspan='4' class='header_cell_e' align='center'>Creditor Entry Form</td>
