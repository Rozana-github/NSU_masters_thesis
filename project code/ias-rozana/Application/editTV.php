...
<form name='frmVoucherEntry' method='post' action='SaveEditMasTrnJournalTV.php'>
...
<table border='0'  width='100%' align='center' cellpadding='3' cellspacing='0'>
        ...
        <tr>
                ...
                <?PHP
                        echo "<input type='hidden' name='txtjournalid' value='".$sjournalid."'>";
                        echo"
      ...
      <tr>
        ...
        <tr>
                <td align='center'  class='td_e' colspan='10'>
                        ...
                        <?PHP
                                ...
                                {
                                        echo"
                                        Cash<input type='radio' name='rdopayto' value='C' class='input_e' checked onClick='DisableChequeInfo()'>
                                        Cheque<input type='radio' name='rdopayto' value='Q' class='input_e' class='input_e'  onClick='EnableChequeInfo()'>
                                        ";
                                }
                                else
                                {
        ...
        <tr>
                ...
                <td  align='left'  class='td_e' colspan='4'>
                        <?PHP
                                ...
                                if($paytype=='C')
                                {
                                        echo "<select name='cboBank' onchange='setAccount(this.value)' class='select_e' disabled>";
                                }
                                else
                                {
                                        echo "<select name='cboBank' onchange='setAccount(this.value)' class='select_e' >";
                                }
                ...
                <td align='left'  class='td_e' colspan='2'>
                        <span id='GridAccount'>
                                <?PHP
                                        $accountname=pick("trn_bank","account_no","account_object_id ='".$account."'");
                                        if($paytype=='C')
                                        {
                                                echo"<select name='cboAccountNo' class='select_e' disabled>";
                                                echo "<option value='-1'>Select A Bank Account</option>";
                                        }
                                        else
                                        {
                                                echo"<select name='cboAccountNo' class='select_e' >";
                                                echo "<option value='".$account."'>".$accountname."</option>";
                                        }
        ...
        <tr>
                ...
                <td align='left'  colspan='4' height='56'  class='td_e'>
                        <textarea rows='3' name='mremarks' cols='50'><?PHP echo $remarks; ?></textarea>
                </td>
                <td align='right'  class='td_e' colspan='2'>
                        Amount:
                </td>
                <td align='left'  class='td_e' colspan='2'>
                <?PHP
                        $amount=pick("trn_journal","amount","journalid='".$sjournalid."' and ttype='Cr'");
                        echo "<input type='text' name='txtAmount' size='10' value='".$amount."' class='input_e'>";
                ?>
                </td>
        </tr>
</table>
        ...
        <tr>
                <td align='center'  class='td_e' colspan='4'>
                        ...
                        <?PHP
                                ...
                                {
                                        echo"
                                        Cash<input type='radio' name='rdoTopayto' value='C' class='input_e' checked onClick='DisableToChequeInfo()'>
                                        Cheque<input type='radio' name='rdoTopayto' value='Q' class='input_e' class='input_e'  onClick='EnableToChequeInfo()'>
                                        ";
                                }
                                else
                                {
                                        ...
                                        Cheque<input type='radio' name='rdoTopayto' value='Q' class='input_e' class='input_e' checked onClick='EnableToChequeInfo()'>
                                        ";
                                }
                        ?>
                </td>
        ...
        <tr>
                ...
                <td  align='left'  class='td_e' >
                        ...
                        <?PHP
                                ...
                                if($tobank==0)
                                {
                                        echo "<select name='cboToBank' onchange='setAccountSec(this.value)' class='select_e' disabled>";
                                }
                                else
                                {
                                        echo "<select name='cboToBank' onchange='setAccountSec(this.value)' class='select_e' >";
                                }
                                createQueryCombo("Bank",$SerachBank,"-1",$tobank);
                        ?>
                        </select>
                </td>
                <td align='right'   class='td_e' >
                ...
                <td align='left'  class='td_e' width='22%'>
                        <span id='GridToAccount'>
                                <?PHP
                                        $toaccountname=pick("trn_bank","account_no","account_object_id ='".$toaccount."'");
                                        if($tobank==0)
                                        {
                                                echo"<select name='cboToAccountNo' class='select_e' disabled>";
                                                echo "<option value='-1'>Select A Bank Account</option>";
                                        }
                                        else
                                        {
                                                echo"<select name='cboToAccountNo' class='select_e' >";
                                                echo "<option value='".$toaccount."'>".$toaccountname."</option>";
                                        }
