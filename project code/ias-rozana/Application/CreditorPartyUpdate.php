...
<body class='body_e'>
<form name='Form1' method='post'  action='AddToCreditorPartyUpdate.php'>
<?PHP
...
<table border='0' width='100%'  cellspacing='0' cellpadding='3'>
        <tr>
                  ...
                  <td colspan='4' width='100%' class='header_cell_e' align='center'>Creditor Party Update Form</td>
        ...
        <tr>
                ...
                <td width='25%' style='text-align:right' class='td_e'><b>Supplier ID</b></td>
                <td width='25%' align='left' class='td_e'>
                        <input type='text' name='txtCustomerID' value='$supplier_id' readOnly class='input_e'>
                </td>
                <td class='rb'></td>
        </tr>
        <tr>
