...
<html>
      <head>
            ...
            <script language='javascript'>
                  ...
                  function doPrint()
                  {
                        window.parent.AssetSumaryReportBottom.focus();
                        window.parent.AssetSumaryReportBottom.print();
                  }
            </script>
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='AssetSumaryReportBottom.php' target='AssetSumaryReportBottom'>
