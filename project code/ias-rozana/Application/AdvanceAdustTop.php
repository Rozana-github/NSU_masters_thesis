...
<html>
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='AdvanceAdustBottom.php' target='AdvanceAdustBottom'>
            <table width='90%' id='table1' cellspacing='0' cellpadding='0' align='center'>
                  ...
                  <tr>
                        ...
                        <td class='td_e'>
                              <select name='cboDebtor' class='select_e' onchange='window.parent.AdvanceAdustBottom.location="blank.php"'>
                                    <?PHP createCombo("Debtor","mas_supplier","supplier_id","company_name","order by company_name",""); ?>
                              </select>
                        </td>
