...
function DrawTable()
{
        ...
        else
        {
                ...
                else
                {
                        ...
                        DataRow[index]+="<tr>";
                        DataRow[index]+="<td  align='center' class='td_e'><input type='text' style='border:0;cursor:hand' Size='15' name='txtcostcenter["+index+"]'  value='"+costcenter_name+"' readonly onclick='EditInformation("+index+");' class='input_e'><input type='hidden' value='"+costcenter+"' name='cmbCostCenter1["+index+"]'></td>";
                        DataRow[index]+="<td  align='center' class='td_e'><input type='text' style='border:0;cursor:hand' name='txtChartofAccount["+index+"]'  value='"+ChartofAccountValue+"' readonly onclick='EditInformation("+index+");' class='input_e'><input type='hidden' value='"+glcode+"' name='txtglcode["+index+"]'></td>";
                        DataRow[index]+="<td  align='center' class='td_e'><input type='text' style='border:0;cursor:hand' name='txtRemarks["+index+"]'  value='"+remarks+"' readonly onclick='EditInformation("+index+");') class='input_e'></td>";
                        DataRow[index]+="<td  align='center' class='td_e'><input type='text' style='border:0;cursor:hand;text-align: right' size='5' name='txtDebitAmount["+index+"]'  value='"+DebitAmount+"' readonly onclick='EditInformation("+index+");' class='input_e' ></td>";
                        DataRow[index]+="<td  class='td_e'><input type='button' value='Delete' name='del["+index+"]' onClick='DeleteDataRow("+index+")' class='forms_button_e'></td>";
...
<form name='frmVoucherEntry' method='post' action='SaveMasTrnJournalPV.php'>
                                ...
                                <?PHP
                                        $party_sql="select
                                                        ...
                                                        order by
                                                                Company_Name
                                                ";
                                        createQueryCombo("Party",$party_sql,'-1',$cmbParty);
