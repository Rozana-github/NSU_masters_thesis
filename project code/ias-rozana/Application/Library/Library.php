<?PHP
      function drawCompanyInformation($ReportName,$ReporDetail=null)
      {
            ...
            echo "      <tr><td align='center'><font size='4px'><b>ABC</b><font></td></tr>";
      ...
      function drawMassage($Massage,$Event)
      {
            ...
            echo "<br><br><br>".
                 "<table style=\"border: 1px solid #000000\"  align='center' top='500' cellpadding='0' cellspacing='0' width='41%' height='94'>".
                 "    <tr><td width='100%' align='center' valign='middle' height='67'><p>&nbsp;$Massage</td></tr>".
                 "    <tr><td width='100%' height='26' class='Button_cell' align='center'><input class='forms_Button' type='button' value='Back' name='B3' $Event></td></tr>".
                 "</table>";
      }
      ...
      {
            echo "<br><br><br>
                  <table border='0' align='center' cellpadding='0' cellspacing='0' width='41%' height='94px'>
                        <tr>
                        ...
                        <tr>
                              <td class='lb'></td>
                              <td align='center' valign='middle' class='td_e'>$Massage</td>
                              <td class='rb'></td>
                        </tr>
                        <tr>
      ...
      function createComboSTR($ComboName,$TableName,$ID,$Name,$Condition,$selectedValue)
      {
            $query="select
                        $ID as ID,
                        $Name as Name
            ...
            $str="";
            $str="<option value='-1'>Select a $ComboName</option>\n";
            while ($qry_row=mysql_fetch_array($ResultSet))
            {
                  $ID=$qry_row["ID"];
                  $Name=$qry_row["Name"];
...
function pickdata($table,$field,$cond,$tdtype,$tcl)
   {
    ...
    function getTitle($ID,$LangType)
    {
        ...
        if($LangType==1)
        {
            return $e_title_lookup_name;
        }
        if($LangType==2)
        {
            return $b_title_lookup_name;
        }
