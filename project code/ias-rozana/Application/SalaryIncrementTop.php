...
<form name='frmEmployeeEntry' method='post' action='SalaryIncrementBottom.php' target='SalaryIncrementBottom'>


<table width='100%' id='table1' cellspacing='0' cellpadding='0' align='center'>
                  <tr>
                        <td class='top_left_curb'></td>
                        <td colspan='3' class='header_cell_e' align='center'>Increment Salary</td>
