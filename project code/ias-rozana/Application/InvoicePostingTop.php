                  ...
                  if($RowCount>0)
                  {
                        ...
                        while($row=mysql_fetch_array($rs))
                        {
                              ...
                              echo "<tr>
                                          ...
                                          <td class='$class'><input type='button' class='forms_button_e' name='btnpost[$i]' value='Post' onclick=\"sendData('$invoiceobjet_id','$vat','$discount_amount','$total_bill','$net_bill','$customer_id','".urlencode($Company_Name)."')\"></td>
                                    </tr>";
                              $i++;
                        }
                        echo "<tr>
