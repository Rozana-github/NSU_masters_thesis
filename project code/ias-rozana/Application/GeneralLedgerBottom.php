...
<html>
      ...
      <body class='body_e'>
            <?PHP
                  ...
                  if($cboMonth=='-1')
                  {
                     $query="select
                          ...
                          where
                              ...
                              trn_journal.glcode='$cboAccountHead'
                         ";
                  }
                  else
                  {
                  ...
                  {
                        if($cboMonth=='-1')
                                drawCompanyInformation("General Ledger of ".pick("mas_gl","description","gl_code='$cboAccountHead'"),"For the year of ".date(" Y", mktime(0, 0, 0, 1,1,$cboYear)));
                        else
                                drawCompanyInformation("General Ledger of ".pick("mas_gl","description","gl_code='$cboAccountHead'"),"For the period of ".date("F, Y", mktime(0, 0, 0, $cboMonth,1,$cboYear)));
                        ...
                        if($CheckVal==0 || $CheckVal==1)
                        {
                              if($cboMonth=='-1')
                              {
                                getPreviousClosing(&$DrAmount,&$CrAmount,$cboAccountHead,1,$cboYear);
                              }
                              else
                              {
                              ...
                              echo "<tr>
                                          <td class='even_left_td_e' align='center' colspan='5'>Opening Balance</td>
