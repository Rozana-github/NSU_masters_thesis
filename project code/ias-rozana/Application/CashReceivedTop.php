...
<html>
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='CashReceivedBottom.php' target='CashReceivedBottom'>
            <table width='90%' id='table1' cellspacing='0' cellpadding='0' align='center'>
                  ...
                  <tr>
                        ...
                        <td class='td_e'>
                              <select name='cboDebtor' class='select_e' onchange='window.parent.CashReceivedBottom.location="blank.php"'>
