...
else
{
 ...
 echo "
      <form name='frm' method='post' action='GLadd.php'>
            <input type='hidden' name='parent' value='$id'>
            <table border='0' width='90%' align='center' cellpadding='0' cellspacing='0'>
                  <tr>
                        <td class='top_left_curb'></td>
                        <td colspan='2' class='header_cell_e' align='center'>Add A GL Head</td>
      ...
      <form name='frm1' method='post' action='GLedit.php'>
            <input type='hidden' name='parent' value='$id'>
                  <table border='0' width='90%' align='center' cellpadding='0' cellspacing='0'>
                        <tr>
                              <td class='top_left_curb'></td>
                              <td colspan='2' class='header_cell_e' align='center'>Edit A GL Head</td>
                              <td class='top_right_curb'></td>
                        </tr>
                        <tr>
                              <td class='lb' rowspan='2'></td>
