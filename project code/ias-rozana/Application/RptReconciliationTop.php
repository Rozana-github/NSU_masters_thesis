...
<html>
      <head>
            ...
            <script language='javascript'>
                  ...
                  function doPrint()
                  {
                        window.parent.RptReconciliationBottom.focus();
                        window.parent.RptReconciliationBottom.print();
                  }
            </script>
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='RptReconciliationBottom.php' target='RptReconciliationBottom'>
            <table width='100%' id='table1' cellspacing='0' cellpadding='0' align='center'>
                  ...
                  <tr>
                        ...
                        <input value='Show Detail' type='button' name='btnsubmit' class='forms_button_e' onclick='sendData()'>
