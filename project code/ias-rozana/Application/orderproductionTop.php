...
function doPrint()
                  {
                        window.parent.rptactionplanBottom.focus();
                        window.parent.rptactionplanBottom.print();
                  }
...
<form name='frmEmployeeEntry' method='post' action='orderproductionBottom.php' target='orderproductionBottom'>


<table width='100%' id='table1' cellspacing='0' cellpadding='0' align='center'>
                  <tr>
                        <td class='top_left_curb'></td>
                        <td colspan='3' class='header_cell_e' align='center'>Month Selection</td>
