...
function doPrint()
                  {
                        window.parent.PaySlipBottom.focus();
                        window.parent.PaySlipBottom.print();
                  }
...
<form name='frmEmployeeEntry' method='post' action='ReportWIPBottom.php' target='ReportWIPBottom'>


<table width='100%' id='table1' cellspacing='0' cellpadding='0' align='center'>
                  <tr>
                        <td class='top_left_curb'></td>
                        <td colspan='5' class='header_cell_e' align='center'>WIP / Finish Goods Stock Entry Month Report</td>
