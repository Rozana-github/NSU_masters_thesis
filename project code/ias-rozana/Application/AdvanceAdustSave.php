            ...
            <?PHP
                  ...
                  $i=1;
                        ...
                        $query="INSERT INTO trn_journal
                                ...
                                VALUES
                                    ('$journalid','$i','10604','$AdvanceCr','Cr')";
                        ...
                        $query="INSERT INTO trn_journal
                                    (journalid,slno,glcode,amount,ttype)
                                VALUES
                                    ('$journalid','$i','$discriptiontype','$AdvanceDr','Dr')";
                  ...
                  for($i=0;$i<$hidIndex;$i++)
                  {
                        if($chkAccept[$i]=="ON")
                        {
                              $query="INSERT INTO mas_invoice_payment
                                    (
                                          invoiceobject_id,
                                          journal_id,
                                          paymentdate,
                              ...
                              {
                                    $query="update mas_supplier_invoice set receive_status='2' where invoiceobjet_id='".$txtInvoiceObjectID[$i]."'";
                                   // echo  $query;
                                    mysql_query($query) or die("Error: Invoice Status: ".mysql_error());
                              }
                              else
                              {
                                    $query="update mas_supplier_invoice set receive_status='1' where invoiceobjet_id='".$txtInvoiceObjectID[$i]."'";
                                  // echo $query;
                                    mysql_query($query) or die("Error: Invoice Status: ".mysql_error());
                              }
                        }
