...
function doPrint()
                  {
                        window.parent.RptProductionStatementBottom.focus();
                        window.parent.RptProductionStatementBottom.print();
                  }
...
<form name='frmEmployeeEntry' method='post' action='RptProductionStatementBottom.php' target='RptProductionStatementBottom'>
