...
<html>
      <head>
            ...
            <script language='javascript'>
                  ...
                  function doPrint()
                  {
                        window.parent.RptReceiveMaterialBottom.focus();
                        window.parent.RptReceiveMaterialBottom.print();
                  }
            </script>
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='RptReceiveMaterialBottom.php' target='RptReceiveMaterialBottom'>
