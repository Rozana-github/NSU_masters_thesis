...
<form name='frmEmployeeEntry' method='post' action='EmpBonusBottom.php' target='EmpBonusBottom'>


<table width='100%' id='table1' cellspacing='0' cellpadding='0' align='center'>
                  <tr>
                        <td class='top_left_curb'></td>
                        <td colspan='5' class='header_cell_e' align='center'>Month selection for Employee Bonus</td>
