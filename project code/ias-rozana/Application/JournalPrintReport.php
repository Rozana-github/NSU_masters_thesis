...
{
                //$vtype=Journal;
                drawCompanyInformation("Transfer Voucher");
}
...
<tr>
  ...
  <td width="20%" >
  <strong><font color="#000000" face="Verdana" size="2"><?PHP echo "$journaldate"; ?>
  </font></strong>
  </td>
</tr>
...
<tr>
  ...
  <td width="36%" >
  <font color="#000000" face="Verdana" size="2">  <?PHP echo "$payto"; ?>
  </font>
  </td>
  <td width="20%" >
