...
function doPrint()
                  {
                        window.parent.RptMonthlyOtBottom.focus();
                        window.parent.RptMonthlyOtBottom.print();
                  }
...
<form name='frmEmployeeEntry' method='post' action='RptMonthlyOtBottom.php' target='RptMonthlyOtBottom'>
