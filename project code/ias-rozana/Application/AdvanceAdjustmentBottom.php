...
<html>
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='AdvanceAdjustmentSave.php'>
            <?PHP
                  $query="select
                  ...
                  if($RowCount>0)
                  {
                        ...
                        echo "<tr>
                                    ...
                                    <td class='td_e'><input type='text' class='input_e' style='text-align:right' name='txtTotalAmount' readonly></td>
                              </tr>";
                        echo "<tr>
                  ...
                  if($RowCount>0)
                  {
                        ...
                        echo "<tr>
                              ...
                              $querydebtorstype="select
                               ...
                               if($type==1)
                               {
                                        $discriptiontype=pick("mas_gl","description","gl_code='10401'");
                                        echo "<input type='hidden' name='discriptiontype' value='10401'>";
                               }
                               else if($type==2)
                               {
