...
if(mysql_num_rows($rsloan)>0)
{
        ...
        drawCompanyInformation("Loan Payment Details ","");
        echo"<table>
                <tr>
                        <td><b>Enployee Name:".pick("mas_employees","employee_name","employeeobjectid='$cboEmployee'")."($description)<br>Loan Name: $loan_description <br>Loan Amount:$loan_amount</b></td>
                </tr>
                </table><br>";
        echo "<table border='0' width='98%' align='center'  cellspacing='0' cellpadding='0'>
                <tr>
                        <td class='title_cell_e_l'>No.</td>
