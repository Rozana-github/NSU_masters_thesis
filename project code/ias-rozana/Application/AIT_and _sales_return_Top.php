...
<html>
      <head>
            ...
            <script language='javascript'>
                  ...
                  {
                        window.parent.InvoicePostingBottom.location="AIT_and _sales_return_Bottom.php?invoiceobjet_id="+invoiceobjet_id+"&vat="+vat+"&discount_amount="+discount_amount+"&total_bill="+total_bill+"&net_bill="+net_bill+"&customer_id="+customer_id+"&Company_Name="+Company_Name+"";
                  }
            </script>
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='AIT_and _sales_return_Bottom.php' target='AIT_and _sales_return_Bottom'>
