...
<html>
      <head>
            ...
            <script language='javascript'>
                  ...
                  function doPrint()
                  {
                        window.parent.banktransactionBottom.focus();
                        window.parent.banktransactionBottom.print();
                  }
            </script>
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='banktransactionBottom.php' target='banktransactionBottom'>
            <table width='100%' id='table1' cellspacing='0' cellpadding='0' align='center'>
                  ...
                  <tr>
                        ...
                        <td class='td_e'>
                              <select name='cboAccount' class='select_e'>
                              <?PHP
                                    $query="select
                                                account_object_id,
                                                account_no
                                            ...
                                            order by
                                                account_no
                                           ";
                                    createQueryCombo("Account No",$query,"-1","");
                              ?>
                              </select>
                        </td>
