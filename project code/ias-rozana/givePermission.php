...
$deletePermission="delete from _nisl_user_permission where User_Name='$userdrop'";
...
while($row = mysql_fetch_array($rset))
{
 ...
 if($c[$id]=="1")
 {
  $insert_query = "Insert into _nisl_user_permission
                   (
                    User_Name,
                    id,
                    pid
  ...
  echo " <table border='0' align='center'>
          <tr>
            <td class='forms_NewTitle'>The Following Tree is Generated for the user: $userdrop </td>
          <tr>
