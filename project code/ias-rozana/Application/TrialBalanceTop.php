...
<html>
      <head>
            ...
            <script language='javascript'>
                  ...
                  function doPrint()
                  {
                        window.parent.TrialBalanceBottom.focus();
                        window.parent.TrialBalanceBottom.print();
                  }
            </script>
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='TrialBalanceBottom.php' target='TrialBalanceBottom'>
