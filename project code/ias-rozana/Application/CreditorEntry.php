...
{
        var popit=window.open('CreditorPartyEntry.php','console','status,scrollbars,width=650,height=350');
}

function EditPartyEntry(val)
{
        var popit=window.open("CreditorPartyUpdate.php?CustomerID="+val+"",'console','status,scrollbars,width=650,height=350');
}
...
<table border='0' cellspacing='0' cellpadding='0'  width='100%' align='center'>
      ...
      <tr>
            ...
            <td colspan='4' class='header_cell_e' align='center'>Creditors List</td>
            <td class='top_right_curb'></td>
      </tr>
      <tr>
            <td class='lb'></td>
            <td align='center' class='title_cell_e2' colspan='4'>
                  <INPUT type='button' value='New Creditor' onClick="CreateNewParty()" class='forms_button_e' style="WIDTH:100px">
            </td>
            <td class='rb'></td>
      </tr>
        ...
        <?PHP
            ...
            if(mysql_num_rows($resultAllInfo)>0)
            {
                  ...
                  <tr>
                        <td class='lb'></td>
                        <td class='title_cell_e'>Supplier ID</Td>
                ...
                while($rowAllInfo=mysql_fetch_array($resultAllInfo))
                {
                        ...
                        echo"
                        <tr  id=set1_row1 onClick='EditPartyEntry(\"$supplierobject_id\")' style=\"cursor: hand;\">
                              <td class='lb'></td>
                              <td class='$clss' style=\"cursor: hand;\">$supplier_id</Td>
