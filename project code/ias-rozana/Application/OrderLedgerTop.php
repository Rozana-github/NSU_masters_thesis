...
function doPrint()
                  {
                        window.parent.OrderLedgerBottom.focus();
                        window.parent.OrderLedgerBottom.print();
                  }
...
<form name='frmEmployeeEntry' method='post' action='OrderLedger.php' target='OrderLedgerBottom'>
