        ...
        <THEAD>
                <TR>
                        <TD  align='center' class='button_cell_e'>
                                <INPUT type='button' value='New Employee' onClick="CreateNewParty()" class='forms_button_e' style="WIDTH:100px">
                        </TD>
                </TR>
                <TR>
      ...
      if($numrows>0)
      {
            ...
            while($rows=mysql_fetch_array($rsemployee))
            {
                  ...
                  if($i%2==0)
                   ...
                   echo "
                              <TR  id=set1_row1 onClick='EditPartyEntry(\"$employeeobjectid\")' style=\"cursor: hand;\">
                                    <TD class='$cls' >".($i+1)."</TD>
