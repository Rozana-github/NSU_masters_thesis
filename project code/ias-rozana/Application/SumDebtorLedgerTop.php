...
<html>
      <head>
            ...
            <script language='javascript'>
                  ...
                  function doPrint()
                  {
                        window.parent.SumDebtorLedgerBottom.focus();
                        window.parent.SumDebtorLedgerBottom.print();
                  }
            </script>
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='SumDebtorLedgerBottom.php' target='SumDebtorLedgerBottom'>
