...
function doPrint()
                  {
                        window.parent.RptEmpLoanBottom.focus();
                        window.parent.RptEmpLoanBottom.print();
                  }
var xmlHttp = false;
try
{
...
<form name='frmEmployeeEntry' method='post' action='RptEmpLoanBottom.php' target='RptEmpLoanBottom'>
