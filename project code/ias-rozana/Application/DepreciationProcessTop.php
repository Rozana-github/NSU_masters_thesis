...
<html>
      <head>
            ...
            <title>Depreciation Posting</title>
            <script language='javascript'>
                  ...
                  function doPrint()
                  {
                        window.parent.DepreciationProcessBottom.focus();
                        window.parent.DepreciationProcessBottom.print();
                  }
            </script>
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='DepreciationProcessBottom.php' target='DepreciationProcessBottom'>
