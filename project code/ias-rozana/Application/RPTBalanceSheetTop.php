...
<form name='frmIOEclear' method='post' action='RPTBalanceSheetBottom.php' target='bottomfrmForReport'>
      <table width='100%' id='table1' cellspacing='0' cellpadding='0' align='center'>
            <tr>
                  <td class='top_left_curb'></td>
                  <Td  class='header_cell_e' colspan='5' align='center'>Income and Expenditure</Td>
