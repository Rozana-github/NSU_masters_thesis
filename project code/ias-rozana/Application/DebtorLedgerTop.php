...
<html>
      <head>
            ...
            <script language='javascript'>
                  ...
                  function doPrint()
                  {
                        window.parent.DebtorLedgerBottom.focus();
                        window.parent.DebtorLedgerBottom.print();
                  }
            </script>
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='DebtorLedgerBottom.php' target='DebtorLedgerBottom'>
            <table width='100%' id='table1' cellspacing='0' cellpadding='0' align='center'>
                  ...
                  <tr>
                        ...
                        <td class='td_e'>
                              <select name='CompanyName' class='select_e'>
                              <?PHP
                                    ...
                                    $query="select
                                          ...
                                          order by
                                                Company_Name";
                                   createQueryCombo("Company",$query,"-1","")
                                    //createCombo("Company","mas_customer","customer_id","Company_Name","","");
                              ?>
                              </select>
                        </td>
