...
<html>
      <head>
            ...
            <script language='javascript'>
                  ...
                  function sendValue()
                  {
                        ...
                        document.MyForm.action="editCashReceivedSave.php";
      ...
      <body class='body_e'>
            <form name="MyForm" method='POST' action='editCashReceivedSave.php'>
            <?PHP
                  echo "<input type='hidden' value='".$sjournalid."' name='txtjournalid'>";
                  $query="select
                              mas_invoice.invoiceobjet_id,
                              mas_invoice.invoice_number,
                              mas_invoice.invoice_date,
                              mas_invoice.net_bill,
                              IFNULL(TEMP.ReceivedAmount-TEMP1.journalAmount,0) AS ReceivedAmount,
                              IFNULL(TEMP1.journalAmount,0) AS journalAmount,
                        ...
                        FROM
                              ...
                              (
                                    select
                                          ...
                                          SUM(collection_amount+ait_amount+sales_return_amount) AS journalAmount
                                    from
                                          mas_invoice_collection
                                    where
                                        mas_invoice_collection.journal_id='".$sjournalid."'
                                    group by
                                          invoiceobjet_id
                              ) AS TEMP1 ON mas_invoice.invoiceobjet_id=TEMP1.invoiceobjet_id
                        WHERE
                  ...
                  if($RowCount>0)
                  {
                        ...
                        while($row=mysql_fetch_array($rs))
                        {
                              ...
                              echo "<tr>
                               ...
                               if($journalAmount>0)
                                        echo "<td class='$class'><input type='checkbox' name='chkAccept[$i]' value='ON' checked ></td>";
                               else
                                        echo "<td class='$class'><input type='checkbox' name='chkAccept[$i]' value='ON' onclick='getAmount($i)'></td>";

                                        echo "<td class='$class'><input type='text' style='text-align:right' class='input_e' name='txtAmount[$i]' value='".$journalAmount."' onchange='calculateTotalAmount()'></td>
                                    </tr>";
                              $i++;
                        }
                        echo "<tr>
                                    <td class='caption_e' colspan='5'>Total Amount</td>
                                    <td class='td_e'><input type='text' class='input_e' style='text-align:right' value='".$amount."' name='txtTotalAmount'></td>
                              </tr>";
                        echo "<tr>
            ...
            <table width='90%' id='table1' cellspacing='0' cellpadding='0' align='center'>
                  ...
                  <tr>
                        ...
                        <?PHP
                              ...
                              if($paytype=='Q')
                              {
                                         echo "Cash<input type='radio' name='rdoReceiveType' value='C'  onclick='checkReceiveType(this.value)'>
                                                Cheque<input type='radio' name='rdoReceiveType' value='Q' checked onclick='checkReceiveType(this.value)' >
                                                ";

                              }
                              else
                              {
                                        echo "Cash<input type='radio' name='rdoReceiveType' value='C' checked onclick='checkReceiveType(this.value)'>
                  ...
                  <tr>
                        ...
                        <td class='td_e'><input type='text' class='input_e' name='txtVoucherNo' value='<?PHP echo "$journalno"; ?>' readonly></td>
                  ...
                  <tr>
                        ...
                        <td class='td_e'>
                              ...
                              <?PHP
                                    createCombo("Bank","mas_bank","bank_id","bank_name","order by bank_name",$bank);
                              ?>
                              </select>
                        </td>
                              ...
                              <span id="BankAccountX">
                                    <select name='cboBankAccount' class='select_e'>
                                        <?PHP
                                                if($account>0)
                                                {
                                                        $accountno=pick("trn_bank","account_no","account_object_id='".$account."'");
                                                        echo "<option value='".$account."'>".$accountno."</option>";
                                                }
                                                else
                                                {
                                                        echo "<option value='-1'>Select a Bank Account</option>";
                                                }
                                        ?>
                                    </select>
                              </span>
                  ...
                  <tr>
                        ...
                        <td class='td_e'><input type='text' class='input_e' name='txtChequeNo' value='<?PHP echo $chequeno;?>'></td>
                  ...
                  <tr>
                        ...
                        <td class='td_e' colspan='3'><textarea name='txaRemarks' class='input_e' cols='80'><?PHP echo $remarks;?></textarea></td>
                  </tr>
                  <tr>
